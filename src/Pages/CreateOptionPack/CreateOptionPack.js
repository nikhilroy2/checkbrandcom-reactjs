...
function CreateOptionsPack(props) {
    ...
    return (
        <div id="CreateOptionsPack" className="my-5">
            <section>
                <div className="container-xxl">
                    <div className="row">
                        <div className="col-12">
                            <h2 className="section_title mb-3 mb-md-5">Create Options Pack</h2>
...
export default CreateOptionsPack;
